        ...
        with sess.as_default(), sess.graph.as_default():
            while not coord.should_stop():
                ...
                while episode_step_count < self.episode_size:
                    ...
                    # 最后的rewardmsg中得到  inter_action_id = x, final_blocking = 1/0
                    # ----------------------------
                    # x = 1
                    # final_blocking = 1
                    ...
                    r_t = 1 - 2 * final_blocking  # successful, 1, blocked, 0
                    # r_t = 1 - blocking
                ...
                if self.name == 'agent_0':
                    ...
                    fp = open("CTRL2_Episode_Time2.log", "a")
...
class DRLThread(threading.Thread):
    ...
    def handle_recvmsg(self, jresponse):
        ...
        for key in jresponse.keys():
            if key == "req_id":
                ...
                src_list.append(int(jresponse[key]))
            elif key == "bandwidth":
    ...
    def run(self):
        ...
        ip_port = (read_Cfg.Serverp_IPv4, int(read_Cfg.Serverp_Port_DRL))
